...
| 文档 | 适合解决的问题 |
| --- | --- |
| [`repository-guide.md`](repository-guide.md) | 每个目录和核心文件是做什么的？修改功能该从哪里开始？ |
...
| [`release-process.md`](release-process.md) | 如何按统一门禁准备、发布、验证和回滚版本？ |
| [`releases/v0.1.1.md`](releases/v0.1.1.md) | `v0.1.1` 向使用者公布了哪些变化和限制？ |
| [`decisions/0001-local-first.md`](decisions/0001-local-first.md) | 为什么采用本地优先架构？ |
| [`../uidesign.md`](../uidesign.md) | 页面配色、字体、间距、组件和可访问性遵循什么规范？ |

如果代码行为、产品范围或架构决策发生变化，应在同一个 Pull Request 中同步更新相关文档。
